    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.CharField(default=orders.models.generate_order_id, editable=False, max_length=6, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discovery_items', to='orders.order')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
